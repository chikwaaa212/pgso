...
/**
 * Super-admin issuances skeleton — mirrors SuperAdminIssuancesPage 1:1
 * (crumb, header + Table/Grid toggle, panel with a straight 9-col table
 * incl. Logged By, no filter row, no pager) so content swaps in without
 * layout shift. The default view is the table, so the skeleton matches
 * that view — same as the personnel skeleton.
 *
