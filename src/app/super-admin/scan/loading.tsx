...
/**
 * Scan-specific skeleton — mirrors SuperAdminScanPage (centered QrScanner
 * idle state, same as personnel) 1:1: crumb, centered header, and the
 * three centered panels (Camera with its start button, Upload with its
 * file input, Paste with its textarea + decode button) so content swaps
...
export default function ScanLoading() {
  return (
    ...
    >
      <p className={styles.crumb}>Super Admin / QR Scanner</p>
