...
/**
 * Repair receipt skeleton — mirrors the read-only oversight receipt.
 */
export default function SuperAdminRepairDetailLoading() {
  return (
    <div className={receiptStyles.page} aria-busy="true" aria-label="Loading repair receipt">
